...
if(src.includes(safe))src=src.replace("const round=TRACKS_2027[Math.max(0,loadRound()-1)]??TRACKS_2027[0];",'');
...
if(src.includes('const round=TRACKS_2027[Math.max(0,loadRound()-1)]')){
  throw new Error('Stale opening round variable remains after attract-boot migration');
}
